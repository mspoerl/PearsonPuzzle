...
//		// Failed to start database '<databaseName>', see te next exception for details
...
//    // -----------------------------------------------------------------------------
//
//    private static String unite(final String[] codeStrings, final boolean random, final int tab) {
//	if (random) {
//	    String buffer;
//	    for (int i = codeStrings.length - 1; i > 0; i--) {
//		int randomInt = new java.util.Random().nextInt(i);
