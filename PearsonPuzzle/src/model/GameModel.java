...
/**
 * Ermöglicht, Punkte zu sammeln oder zu verlieren. Dabei können die Punkte in
 * Module aufgeteilt werden. Der Gesamtpunktestand findet sich stets im Modul
 * "main". Die angegebene maximale Punktzahl bezieht sich auf das Punktemodul
 * main. Diese kann nicht überschritten werden. Es ist durchgehend folgende
 * Bedungung erfüllt:<br>
 * <b>Punkte der Module (ohne "main") in Summe = Punkte des Moduls "main" <
 * maxScore</b>
 * 
 * <dl>
 * <dt>Dabei ist zu beachten:
 * <dt>
 * <dd>- Negativer Punktestand ist möglich und nicht nach unten begrenzt.</dd>
 * <dd>- score(String module) setzt den Punktestand des Moduls auf 1, wenn er <=
 * 0 ist</dd>
 * <dd>- loose(String module) setzt den Punktestadn des Moduls auf -1, wenn er
 * >= 0 ist</dd>
 * <dd>- mit score(String module, int points) bzw. loose(String module, int
 * points) wird der Punktestand nach Belieben verändert.</dd>
 * </dl>
 * 
 * @author workspace
 * 
...
public class GameModel extends Observable {
    ...
    /**
     * Game Model, das für den Kompiler, jeden Reihenfolgentest und für eine
     * vorahandene JUnit-Testklasse den Maximalen Punktestand um 1 erhöht.
     * 
     * @param model
     */
	...
	if (model.getJUnitCode() != null
		&& !model.getJUnitCode().trim().isEmpty())
	    maxScore += 1;
    }

    /**
     * Verändert den Punktestand des angegeben Moduls um die angegeben
     * Punktezahl. Der Maximale Punktestand kann nicht überschritten werden.
     * Wird ein zu hoher Punktestand übergeben, wird stattdessen der maximal
	...
	if (scoreModules.containsKey(module))
	    scoreModules.put(module,
		    scoreModules.get(module) + Math.abs(points));
	else
    ...
    /**
     * Setzt den Punktestand des angegebenen Moduls auf 1, falls dieser <= 0
     * ist.
     * 
     * @param module
     *            Modulname
    ...
    /**
     * Gibt den Aktuellen Punktestand des angegeben Moduls zurück. Das Modul
     * "main" beinhaltet den Gesamtpunktestand.
     * 
     * @param module
     *            Modulname
     * @return Punktestand
	...
	ImageIcon[] images = {
		new ImageIcon("rsc/icon/Smiley/face-crying.png"),
