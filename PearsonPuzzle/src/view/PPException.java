...
public class PPException extends Exception {
    ...
    public PPException(int maximaleLänge, int aktuelleLänge,
	    String betroffenesFeld) {
	super();
	this.reason = "<html>" + betroffenesFeld + " leider zu lang. ("
		+ aktuelleLänge + " Zeichen)<br>Bitte maximal " + maximaleLänge
		+ " Zeichen verwenden</html>";
    }
	...
	case noDatabaseExists:
	    ...
	    n = JOptionPane.showOptionDialog(null, noDatabaseExists, null,
	...
	case anotherDatasetExists:
	    n = JOptionPane.showOptionDialog(null, anotherDatasetExists, null,
		    JOptionPane.YES_NO_CANCEL_OPTION,
		    JOptionPane.QUESTION_MESSAGE, // Icon
		    null, yesNoCancelOptions, yesNoCancelOptions[0]);
	    answer = yesNoCancelOptions[n];
	...
	case anotherInstanceIsRunnign:
	    JOptionPane.showMessageDialog(null, anotherInstanceIsRunnign, null,
	    ...
	    break;
	default:
	    JOptionPane.showMessageDialog(null, reason, null,
