...
public class ConfigEditor extends JView {
	...
	editGroup_Buttons.setLayout(new BoxLayout(editGroup_Buttons,
		BoxLayout.Y_AXIS));

	newGroup = new JButton(
		"<html><body style=\"text-align:center;\">Gruppe<BR>hinzufügen</body></html>");
	newGroup.setIcon(new ImageIcon("rsc/icon/file/data_add.png"));
	deleteGroup = new JButton(
		"<html><body style=\"text-align:center;\">Gruppe<BR>löschen</body></html>");
	deleteGroup.setIcon(new ImageIcon("rsc/icon/file/data_delete.png"));
	editGroup = new JButton(
		"<html><body style=\"text-align:center;\">Gruppe<BR>explizieren</body></html>");
	...
	testPhrase_Buttons.setLayout(new BoxLayout(testPhrase_Buttons,
		BoxLayout.Y_AXIS));
	showHelp = new JButton(
		"<html><body style=\"text-align:center;\">Hilfe<BR>anzeigen</body></html>");
	...
	if (model.getGroupMatrix() != null && !model.getGroupMatrix().isEmpty()) {
		...
		// Hier werden Gruppennamen vergeben Gruppe A.... Gruppe Z,
		// Gruppe A2, ... Gruppe Z2, ...
		String groupName;
		if (i + 65 < 91)
		    groupName = "Gruppe " + (char) (i + 65);
		else
		    groupName = "Gruppe " + (char) (i % 26 + 65) + (i - i % 26)
			    / 26 + 1;
