...
public class PreViewEditor extends JView {
	...
	messagePanel
		.setText("Information: In diesem Modus stehen dem Schüler die Reihenfolgen-Muster nicht zur Verfügung. In diesem Modus macht es nur Sinn, den generierten Code zu kompilieren und mit JUnit test zu testen.");
	if (Puzzlemode != 3)
	    messagePanel.setVisible(false);

	JPanel selectDragAndDrop = new JPanel();
	selectDragAndDrop.setLayout(new BoxLayout(selectDragAndDrop,
		BoxLayout.Y_AXIS));
	selectDragAndDrop.setAlignmentX(Component.CENTER_ALIGNMENT);
	selectDragAndDrop
		.add(new JLabel(
			"<html><body text-align=\"center\"><p align=\"center\">Drag&Drop Modus <br>wählen:</p></body></html>"));
	...
	ImageIcon[] dragIcons = {
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_1.jpg"),
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_2.jpg"),
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_3.jpg"),
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_4.jpg") };
	ImageIcon[] dragIcons_pressed = {
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_1_pressed.jpg"),
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_2_pressed.jpg"),
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_3_pressed.jpg"),
		new ImageIcon("rsc/icon/Drag_n_Drop/Icon_4_pressed.jpg") };
	...
	randomize = new JButton(
		"<html><body><p align=\"center\">Liste neu<br>randomisieren</p></body></html>.");
	randomize.setAlignmentX(Component.CENTER_ALIGNMENT);
	randomize.setIcon(new ImageIcon("rsc/icon/file/dice_white.png"));
	save = new JButton(
		"<html><body text-align=\"center\"><p align=\"center\">D&D Modus<br>Speichern</p></body></html>");
	save.setIcon(saveIcon);
	save.setAlignmentX(Component.CENTER_ALIGNMENT);
	sort = new JButton(
		"<html><body text-align=\"center\"><p align=\"center\">Sortierung<br>Speichern</p></body></html>");
