...
public class UnitEditor extends JView {
	...
	if (model.getImport("classes") == null
		|| model.getImport("classes").isEmpty())
	    addClasses = new JButton(
		    "<html><body>Zum Ausführen nötige <b>Klassen hinzufügen</b></body></html>");
	else
	    addClasses = new JButton(
		    "<html><body>Zum Ausführen nötige <b>Klassen bearbeiten</b></body></html>");
	...
	if (model.getImport("methods") == null
		|| model.getImport("methods").isEmpty())
	    addMethods = new JButton(
		    "<html><body>Zum Ausführen nötige <b>Methoden hinzufügen</b></body></html>");
	else
	    addMethods = new JButton(
		    "<html><body>Zum Ausführen nötige <b>Methoden bearbeiten</b></body></html>");
	...
	showHelp = new JButton(
		"<html><body style=\"text-align:center;\">Hilfe</body></html>");
	...
	if (arg == DCCommand.Compile) {
	    ...
	    // FIXME: Nur, falls ein Test existeiert! Zusätzlich noch
	    // Reihenfolgentest.
