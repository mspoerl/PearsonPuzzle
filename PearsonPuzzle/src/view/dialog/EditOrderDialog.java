...
public class EditOrderDialog extends JDialog implements Observer {
    ...
    public final String[] yesNoCancelOptions = { "Speichern", "Fertig",
	    "Abbrechen" };
	...
	String failureText = model.getOrderFailureText(orderGroup
		.getSelectedIndex());
	...
	if (model.getGroupMatrix().size() == 0) {
	    optionPane = new JOptionPane(
		    "Es sind keine Gruppen vorhanden, die man löschen könnte",
		    JOptionPane.PLAIN_MESSAGE, JOptionPane.INFORMATION_MESSAGE);
	} else {
	    optionPane = new JOptionPane(dialogPanel,
