...
public class AddImportDialog extends JDialog {
	...
	if (getTitle().equals("Nötige Klassen")) {
	    instruction = new JLabel(
		    "<html>Geben Sie hier alle <B>Klassen</B> in Textform ein, die für das Ausführen des Programms benötigt werden.</html>");
	    // input.setText(model.getImport("classes"));
	    textArea.setText(model.getImport("classes"));
	} else if (getTitle().equals("Nötige Methoden")) {
	    instruction = new JLabel(
		    "<html>Geben Sie hier <B>Methoden</B> in Textform ein, die für das Ausführen des Programms benötigt werden.</html>");
	    // input.setText(model.getImport("methods"));
	    textArea.setText(model.getImport("methods"));
	} else if (getTitle().equals("Nötige Imports")) {
	    instruction = new JLabel(
		    "<html>Geben Sie hier <B>Imports</B> ein, die für das Ausführen des Programms benötigt werden.</html>");
	...
	optionPane = new JOptionPane(contentPanel, JOptionPane.PLAIN_MESSAGE,
