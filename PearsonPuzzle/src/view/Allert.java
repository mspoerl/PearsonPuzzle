...
public enum Allert {
	...
	case help_Orders:
	    JOptionPane
		    .showMessageDialog(
			    parentComponent,
			    "<html><head><style type=\"text/css\"> p, ul, li { text-align:justify;}</style></head><body style=\"width: 700px; text-align: center;\">"
	...
	case help_UnitTest:
	    JOptionPane
		    .showMessageDialog(
			    parentComponent,
			    "<html><head><style type=\"text/css\"> p { text-align:justify;}</style></head><body style=\"width:700px; text-align: center;\"><p>Hier kann ein JUnit Test verfasst werden, der den zusammengepuzzelten Code testet (falls dieser kompilierbar ist). "
	...
	case code_not_fully_sorted:
	    JOptionPane
		    .showMessageDialog(
			    parentComponent,
			    "<html><body>Code nicht vollstädnig sortiert, bitte sortieren Sie den Code fertig.<br> Erst dann ist diese Aktion möglich.</body></html>");
	    return null;
	case noContentInput:
	    JOptionPane.showMessageDialog(parentComponent,
		    "Bitte Titel und Inhalt des Projekts angeben");
	    return null;
	case projectSaved:
	    JOptionPane.showMessageDialog(parentComponent,
		    "Projekt wurde erfolgreich gespeichert");
	    return null;
	case projectDeleted:
	...
	case projectExists:
	    JOptionPane
		    .showMessageDialog(
			    parentComponent,
			    "Es existert ein Projekt mit gleichem Namen.\nBitte wählen Sie einen anderen Namen.");
	    return null;
	case notSaved:
	    n = JOptionPane
		    .showOptionDialog(
