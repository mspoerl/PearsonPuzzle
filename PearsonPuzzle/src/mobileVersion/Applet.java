 ...
 * (per Webstart) geladen werden zu können. Da Lese- und Schreibrechte, sowie
 * die Nutzung eines Class Loaders notwendig sind, kannd die Applikation
 * allerdings nicht im Sandbox-Modus ausgeführt werden. Vergleiche hierzu:
 * https://docs.oracle.com/javase/tutorial/deployment/webstart/index.html
 * 
 * Das Applet kann auch aus dem Betrieb heraus instanziert werden. Dies kann auf
 * verschiedene Arten geschehen:
 * <ul>
 * Ein neues Model wird vom Konstruktor angelegt
 * <li>Applet app = new Applet(); app.createGUI();</li>
 * </ul>
 * <ul>
 * Das Model wird vorher festgelegt:
 * <li>Model model = new Model(); Applet app = new Applet(model);
 * app.createGUI()</li>
 * <li>Model model = new Model(); Applet app = new Applet();
 * app.createGUI(model)</li>
 * <li>Model model = new Model(); Applet app = new Applet(model);
 * app.createGUI(model)</li>
 * </ul>
 * 
...
public class Applet extends JFrame {
	...
	// Falls keine Projekte in der Datenbank zu finden sind, wird hier
	// direkt ein
