...
/**
 * Eine JList kann durch diesen Controller mit Drag&Drop versehen werden. Die
 * Klasse besteht im wesentlichen aus Methoden, die
 * <ul>
 * <li>Das Exportieren von Daten regeln
 * <ul>
 * <li>Die Selektion in der Liste wird zum Export bereitgestell.</li>
 * <li>Mögliche Transferaktionen (COPY/MOVE) werden bekannt gegeben.</li>
 * <li>Nach dem Export können Listeneinträge entfernt werden</li>
 * </ul>
 * </li>
 * <li>Das Importieren von Daten regeln
 * <ul>
 * <li>Erlaubtheit des Imports wird bekanntgegeben</li>
 * <li>Der Import wird verarbeitet</li>
 * </ul>
 * </li>
 * <li>Das Verhalten der Liste zur Laufzeit verändern können (nicht
 * standardmäßig)
 * <ul>
 * <li>Elemtente können oder können nicht mehr zurück gedropt werden</li>
 * <li>Elemente werden aus der Liste entfernt (MOVE) oder kopiert (COPY)</li>
 * </ul>
 * </li>
 * </ul>
 * 
...
public class FromTransferHandler extends TransferHandler {
    ...
    private boolean canRevertAction; // Gibt an, ob Elemente wieder zurück in
				     // die Liste gedropt werden können.
    ...
    public FromTransferHandler(DefaultListModel<String> dragDList,
	    JList<String> dragJList, Model model) {
